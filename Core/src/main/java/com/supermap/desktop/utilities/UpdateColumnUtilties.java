...
public class UpdateColumnUtilties {
    ...
    private static String[] basicMathMethodStrs = {"+", "-", "*", "/", "%", ">", ">=", "<", "<>", "<=", "==", "!="};
    ...
    public static String getBasicMathMethodStr(String method) {
        String result = null;
        for (String temp : basicMathMethodStrs) {
            if (method.contains(temp)) {
                if (">".equals(temp) && method.contains("=")) {
                    result = ">=";
                } else if ("<".equals(temp) && method.contains(">")) {
                    result = "<>";
                } else if ("<".equals(temp) && method.contains("=")) {
                    result = "<=";
                } else {
