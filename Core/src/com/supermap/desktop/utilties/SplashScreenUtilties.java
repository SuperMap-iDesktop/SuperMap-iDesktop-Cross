 ...
 * 启动界面输出加载信息
 */
public class SplashScreenUtilties {

	private static SplashScreenUtilties splashScreenUtiltiesInstance;
...
//		graphics2D.drawRect(0,(int) (screenHeight - height), (int) screenWidth -1, height -5);
	...
	public static SplashScreenUtilties getSplashScreenUtiltiesInstance() {
		if (SplashScreen.getSplashScreen() == null) {
			return null;
		}
		if (splashScreenUtiltiesInstance == null) {
			synchronized (SplashScreenUtilties.class) {
				if (splashScreenUtiltiesInstance == null) {
					splashScreenUtiltiesInstance = new SplashScreenUtilties();
				}
			}
		}
	...
	public static void setBundleCount(int count) {
		SplashScreenUtilties.modelCount = count;
	}
