...
public class DataViewResources {
	...
	* */
	public static URL getResourceURL(String resourceName) {
		return getResourceURL(DataViewResources.class, resourceName);
	}
	...
	* */
	public static Icon getIcon(String iconName) {
		return getIcon(DataViewResources.class, iconName);
	}
