title: SuperMap iDesktop Cross 9D Product Introduction
---

　　

　　SuperMap iDesktop Cross 9 d is based on SuperMap iObjects Java 9 d, OSGI platform, through the Java language development plug-in, cross-platform GIS application software, provides data management, data processing, data analysis, mapping out the figure, the 3 d scene browse (currently only Windows platform support), and other functions, and provides a flexible framework and auxiliary control that allows users to secondary development.

 　　SuperMap iDesktop Cross 9D的源代码分别开源在[OSChina](http://git.oschina.net/supermap/SuperMap-iDesktop-Cross)和[CSDN](https://code.csdn.net/SuperMapDesktop/supermap-idesktop-cross/tree/master)两大平台上。
