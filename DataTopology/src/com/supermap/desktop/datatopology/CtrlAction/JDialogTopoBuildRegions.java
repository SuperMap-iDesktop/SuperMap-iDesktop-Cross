...
public class JDialogTopoBuildRegions extends SmDialog {
	...
	private void initPanelDatasource() {
		...
		panelDatasource.add(comboBoxDatasource, new GridBagConstraintsHelper(1, 0, 1, 1).setAnchor(GridBagConstraints.CENTER).setInsets(5, 10, 0, 10).setFill(GridBagConstraints.BOTH).setWeight(60, 1));
		...
		panelDatasource.add(comboBoxDataset,    new GridBagConstraintsHelper(1, 1, 1, 1).setAnchor(GridBagConstraints.CENTER).setInsets(5, 10, 10, 10).setFill(GridBagConstraints.BOTH).setWeight(60, 1));
		// @formatter:on
	}
