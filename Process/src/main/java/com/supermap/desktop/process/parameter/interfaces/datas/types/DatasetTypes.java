...
public final class DatasetTypes extends Type {
	...
	public final static DatasetTypes SIMPLE_VECTOR_AND_GRID = new DatasetTypes("SimpleVectorAndGrid",
			POINT.getValue() | LINE.getValue() | REGION.getValue() | GRID.getValue());
