...
public class ParameterTextAreaPanel extends JPanel {
    ...
    private void initLayout() {
        ...
        this.add(textArea, new GridBagConstraintsHelper(0, 1, 1, 1).setWeight(1, 1).setAnchor(GridBagConstraints.CENTER).setFill(GridBagConstraints.HORIZONTAL).setInsets(5, 0, 0, 0).setIpad(0, 30));
    }
