...
public class UniversalMatrix {
    ...
    *@param nodeName 节点名称
    ...
    public ArrayList<Object> listAllNode() {
        ArrayList<Object> result = new ArrayList<>();
        Iterator iterator = nodeHashMap.entrySet().iterator();
        while (iterator.hasNext()) {
            java.util.Map.Entry<String,Object> entry = (Map.Entry<String, Object>) iterator.next();
