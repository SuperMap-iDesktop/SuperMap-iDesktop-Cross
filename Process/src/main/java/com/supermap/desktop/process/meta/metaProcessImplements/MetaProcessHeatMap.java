...
public class MetaProcessHeatMap extends MetaProcess {
    ...
    private void initMetaInfo() {
        ...
        ParameterComboBox parameterCacheType = new ParameterComboBox().setDescribe("").setItems(new ParameterDataNode[]{new ParameterDataNode("HeatMap", "HeatMap")});
        ...
        ParameterTextField parameterXYIndex = new ParameterTextField().setDescribe("");
        parameterXYIndex.setSelectedItem("10,11");
        ParameterTextField parameterCacheLevel = new ParameterTextField().setDescribe("");
        parameterCacheLevel.setSelectedItem("1");
        ParameterTextField parameterCacheName = new ParameterTextField().setDescribe("");
        parameterCacheName.setSelectedItem("test1_heat");
        ParameterComboBox parameterDatabaseType = new ParameterComboBox().setDescribe("").setItems(new ParameterDataNode[]{new ParameterDataNode("MongoDB", "MongoDB")});
        ParameterTextField parameterServiceAddress = new ParameterTextField().setDescribe("");
        parameterServiceAddress.setSelectedItem("192.168.15.245:27017");
        ParameterTextField parameterDatabase = new ParameterTextField().setDescribe("");
        parameterDatabase.setSelectedItem("test");
        ParameterTextField parameterVersion = new ParameterTextField().setDescribe("");
