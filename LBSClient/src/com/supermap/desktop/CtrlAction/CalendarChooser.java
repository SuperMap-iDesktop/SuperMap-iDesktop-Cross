...
/**
 * 
 * Copyright: Ares. All Rights Reserved. Company: Insigma HT/上海创图
 * 
 ...
 *       Revision History
 *
 *       Date Programmer Notes --------- --------------------- -------------------------------------------- 2013-11-17 Ares initial 2014-09-16 Ares fix bug @n3k123
 * 
 *       1. you can change date format by parameter. 2. you can change week label content by showTEXT. 3. you can change dayOfWeek order by defaultStartDAY.
 */
public class CalendarChooser extends JPanel {
	...
	private CalendarChooser(java.util.Date date, String format, int startDAY) {
	...
	public static CalendarChooser getInstance(java.util.Date date, String format) {
		return new CalendarChooser(date, format, defaultStartDAY);
	}

	public static CalendarChooser getInstance(java.util.Date date) {
		return getInstance(date, DEFAULTFORMAT);
	}

	public static CalendarChooser getInstance(String format) {
	...
	private class LabelManager {
		...
		public LabelManager() {
			list = new ArrayList<CalendarChooser.DayLabel>();
		}
