...
public class CtrlActionNewDataset extends CtrlAction {
	...
	public void run() {
//		try {
		com.supermap.desktop.CtrlAction.Dataset.createNewDataset.JDialogDatasetNew dialog = new com.supermap.desktop.CtrlAction.Dataset.createNewDataset.JDialogDatasetNew();
		dialog.showDialog();
