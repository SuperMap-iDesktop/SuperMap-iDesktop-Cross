...
public class ThemeItemLabelDecorator {
	...
	public static ImageIcon buildGeoStyleIcon(Dataset dataset, GeoStyle geoStyle) {
		...
		Geometry geometry = getGeometryByDatasetType(dataset);
