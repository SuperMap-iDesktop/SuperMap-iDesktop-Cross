 ...
 *         通过绘制多边形对图层进行地图裁剪
 */
public class CtrlActionMapClipAsPolygon extends CtrlAction {
	public CtrlActionMapClipAsPolygon(IBaseItem caller, IForm formClass) {
	...
	private void setAction() {
		...
		activeMapControl.setAction(Action.CREATEPOLYGON);
