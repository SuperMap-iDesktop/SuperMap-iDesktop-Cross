 ...
 */
public class CtrlActionWorkspaceSingleCache extends CtrlAction {
	public CtrlActionWorkspaceSingleCache(IBaseItem caller, IForm formClass) {
	...
	protected void run() {
		...
		singleCache.setMap(CacheUtilities.getWorkspaceSelectedMap());
