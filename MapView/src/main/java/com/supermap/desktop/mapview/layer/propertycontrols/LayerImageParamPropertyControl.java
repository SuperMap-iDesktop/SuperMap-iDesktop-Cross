...
public class LayerImageParamPropertyControl extends AbstractLayerPropertyControl {
	...
	private ButtonColorSelector buttonTransparentColor;
	...
	protected void initializeComponents() {
		...
		this.buttonTransparentColor = new ButtonColorSelector();
	...
	protected void registerEvents() {
		...
		this.buttonTransparentColor.addPropertyChangeListener(ButtonColorSelector.PROPERTY_COLOR, this.propertyChangeListener);
	}
	...
	protected void unregisterEvents() {
		...
		this.buttonTransparentColor.removePropertyChangeListener(ButtonColorSelector.PROPERTY_COLOR, this.propertyChangeListener);
	}
