...
public final class SlimFlatDockingTheme extends DockingWindowsTheme {
	...
	public static final RootWindowProperties createRootWindowProperties() {
		...
		ViewTitleBarStateProperties stateProps = rootWindowProperties.getViewProperties().getViewTitleBarProperties().getNormalProperties();
	...
	private static void setWindowBarProperties(WindowBarProperties windowBarProperties) {
		...
		windowBarProperties.getTabWindowProperties().getTabProperties().getTitledTabProperties().getNormalProperties().getComponentProperties()
				.setInsets(new Insets(0, 4, 0, 4)).setBorder(border);

		windowBarProperties.getTabWindowProperties().getTabProperties().getTitledTabProperties().getHighlightedProperties().getComponentProperties()
				.setBorder(border);
	}
