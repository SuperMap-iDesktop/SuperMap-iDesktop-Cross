...
/**
 * A map of views that handles view serialization by assigning an integer id to each view. The id is unique for each view in the map. To guarantee serialization
 * compatibility a view id must remain constant.
 *
