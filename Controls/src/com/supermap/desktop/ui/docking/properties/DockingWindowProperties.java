...
import com.supermap.desktop.ui.docking.title.DockingWindowTitleProviderProperty;
...
public class DockingWindowProperties extends PropertyMapContainer {
	 ...
	 */
	public static final PropertyMapProperty TAB_PROPERTIES = new PropertyMapProperty(PROPERTIES, "Tab Properties",
			"Property values for the window tab when the window is located in a TabWindow or a WindowBar.", WindowTabProperties.PROPERTIES);
	 ...
	 * @since IDW 1.4.0
	 */
	public static final PropertyMapProperty DROP_FILTER_PROPERTIES = new PropertyMapProperty(PROPERTIES, "Drop Filter Properties",
			"Property values for drop filters.", DockingWindowDropFilterProperties.PROPERTIES);
	 ...
	 * @since IDW 1.2.0
	 */
	public static final BooleanProperty DRAG_ENABLED = new BooleanProperty(PROPERTIES, "Drag Enabled", "Enables/disables window drag by the user.",
	 ...
	 * @since IDW 1.4.0
	 */
	public static final BooleanProperty UNDOCK_ENABLED = new BooleanProperty(PROPERTIES, "Undock Enabled",
			"Enables/disables if a window can be undocked to a floating window.", PropertyMapValueHandler.INSTANCE);
	/**
	 * <p>
	 ...
	 * @since IDW 1.4.0
	 */
	public static final BooleanProperty UNDOCK_ON_DROP = new BooleanProperty(PROPERTIES, "Undock when Dropped",
			"Enables/disables window undock to floating window when a drag and drop is performed outside the root window.", PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since IDW 1.4.0
	 */
	public static final BooleanProperty DOCK_ENABLED = new BooleanProperty(PROPERTIES, "Dock Enabled",
			"Enables/disables if a window can be docked to the root window from a floating window.", PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since IDW 1.2.0
	 */
	public static final BooleanProperty MINIMIZE_ENABLED = new BooleanProperty(PROPERTIES, "Minimize Enabled", "Enables/disables window minimize by the user.",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since IDW 1.2.0
	 */
	public static final BooleanProperty CLOSE_ENABLED = new BooleanProperty(PROPERTIES, "Close Enabled", "Enables/disables window close by the user.",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since IDW 1.2.0
	 */
	public static final BooleanProperty RESTORE_ENABLED = new BooleanProperty(PROPERTIES, "Restore Enabled", "Enables/disables window restore by the user.",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since IDW 1.2.0
	 */
	public static final BooleanProperty MAXIMIZE_ENABLED = new BooleanProperty(PROPERTIES, "Maximize Enabled", "Enables/disables window maximize by the user.",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since IDW 1.3.0
	 */
	public static final DockingWindowTitleProviderProperty TITLE_PROVIDER = new DockingWindowTitleProviderProperty(PROPERTIES, "Title Provider",
			"Provides a title for a window.", PropertyMapValueHandler.INSTANCE);
	 ...
	 *
	 * @param enabled if true, a window can be undocked to a floating window, otherwise it's disabled
	 * @return this
	 * @since IDW 1.4.0
	 */
	 ...
	 *
	 * @param enabled if true, a window can be docked to the root window from a floating window, otherwise it's disabled
	 * @return this
	 * @since IDW 1.4.0
	 */
