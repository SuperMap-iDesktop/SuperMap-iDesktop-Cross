...
public abstract class SymbolPanel extends JPanel {
	...
	private String getFitText(Font font) {
		...
		Dimension preferredSize = new Dimension(fontSize + 10, (int) (labelDimension.getHeight() + line * (FontUtilties.getStringHeight(CommonProperties.getString(CommonProperties.OK), font) + 2)));
