...
/**
 * A group of properties. The group have a name and a description. It can also have a super group from which it inherit all it's properties. You can think of a
 * property group as similar to a Java class, and properties similar to class fields.
 *
