...
public final class TabLayoutPolicy extends Enum {
	...
	/**
	 * Scrolling layout policy. This means that the tabs are laid out in a line. The line of tabs will be scrollable if not all tabs can fit into the visible
	 * part of the tabbed panel's tab area at the same time.
	 */
	public static final TabLayoutPolicy SCROLLING = new TabLayoutPolicy(0, "Scrolling");

	/**
	 * Compression layout policy. This means that the tabs are laid out in a line. The tabs will be downsized (compressed) so that they fit into the visible
	 * part of the tab area.
	 */
	 ...
	 */
	private static final TabLayoutPolicy[] LAYOUT_POLICIES = new TabLayoutPolicy[] { SCROLLING, COMPRESSION };
