...
public class TabbedUtils {
	 ...
	 *
	 * <p>
	 * <strong>Note:</strong> This is not a method for retrieving the tab for a specific content component. This method is only useful for finding the Tab for
	 * components that have been added to a Tab.
	 * </p>
	 *
	...
	public static Tab getParentTab(Component component) {
		...
		while (componentTemp != null) {
			if (componentTemp instanceof Tab)
				return (Tab) componentTemp;
