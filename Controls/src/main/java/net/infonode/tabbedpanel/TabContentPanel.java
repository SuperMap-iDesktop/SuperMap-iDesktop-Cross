...
/**
 * A TabContentPanel is a container for tabs' content components. It listens to a tabbed panel and manages the tabs' content components by showing and hiding
...
public class TabContentPanel extends JPanel {
	...
	private transient StackableLayout layout = new StackableLayout(this);
	private transient TabListener listener = new TabAdapter() {
		@Override
	 ...
	 *
	 * <p>
	 * <strong>Note:</strong> setTabbedPanel(...) must be called before the tabs' content components can be shown on the screen.
	 * </p>
	 *
	 * @since ITP 1.4.0
	 */
