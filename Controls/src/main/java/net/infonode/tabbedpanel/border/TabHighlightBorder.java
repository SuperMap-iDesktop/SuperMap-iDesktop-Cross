...
/**
 * TabHighlightBorder draws a 1 pixel wide highlight on the top and left side of the tab. It will not draw highlight on the side towards a TabbedPanel's content
 * area if the border is constructed with open border.
 *
...
public class TabHighlightBorder implements Border, Serializable {
	 ...
	 * @param openBorder when true, no highlighting is drawn on the side towards a TabbedPanel's content area, otherwise false
	 */
