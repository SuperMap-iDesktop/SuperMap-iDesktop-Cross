...
/**
 * <p>
 * TabbedPanelTitledTabHoverAction is an action that makes it easy to change properties for a hovered {@link TabbedPanel} containing {@link TitledTab}s. The
 * action is meant to be set as a {@link HoverListener} for the entire tabbed panel, the tab area, the tab area components area and/or the content area in their
 * corresponding properties objects.
 * </p>
 *
 * <p>
 ...
 *
 * <p>
 * This hover action contains a TabbedPanelProperties object that will be added as super object to the hovered tabbed panel and then automatically removed when
 * the area is no longer hovered. It also contains a TitledTabProperties object that will be added as super object to all titled tabs in the hovered tabbed
 * panel and then removed when the tabbed panel is no longer hovered.
 * </p>
 *
 * <p>
 * If a titled tab is added to the tabbed panel while the tabbed panel is hovered, the action will automatically add the TitledTabProperties to the titled tab.
 * If a titled tab is removed while the tabbed panel is hovered, the properties will automatically be removed.
 * </p>
 *
 * <p>
 * <strong>Note: </strong> This action is not meant to be set as hover listener in the TitledTabProperties for a titled tab. For TitledTab, use
...
public class TabbedPanelTitledTabHoverAction implements HoverListener {
	...
	private TabAdapter tabListener = new TabAdapterLisenter();

	/**
	 * Creates a TabbedPanelTitledTabHoverAction containing an empty TabbedPanelProperties object and an empty TitledTabProperties object. The
	 ...
	 *
	 * @param allTabs true if TitledTabProperties should be applied to all tabs, false if only to the highlighted tab
	 */
	...
	/**
	 * Creates a TabbedPanelTitledTabHoverAction with the given TabbedPanelProperties object and the given TitledTabProperties object. The TitledTabProperties
	 * are only applied to the highlighted tab.
	 *
	...
	class TabAdapterLisenter extends TabAdapter {

		@Override
		public void tabAdded(TabEvent event) {
			if ((event.getTab() instanceof TitledTab) && (!onlyHighlighted || (onlyHighlighted && event.getTab().isHighlighted()))) {
