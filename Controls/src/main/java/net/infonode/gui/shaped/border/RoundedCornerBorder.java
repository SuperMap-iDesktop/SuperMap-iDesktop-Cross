...
public class RoundedCornerBorder extends PolygonBorder {
	...
	private static int[][] corner1 = { { 0, 0 }, { 0, 1, 1, 0 }, { 0, 2, 2, 0 }, { 0, 4, 1, 3, 1, 2, 2, 1, 3, 1, 4, 0 }, { 0, 5, 1, 4, 1, 3, 3, 1, 4, 1, 5, 0 } };

	private static int[][] corner2 = { { -1, 0 }, { -2, 0, -1, 1 }, { -3, 0, -1, 2 }, { -5, 0, -4, 1, -3, 1, -2, 2, -2, 3, -1, 4 },
			{ -6, 0, -5, 1, -4, 1, -2, 3, -2, 4, -1, 5 } };

	private static int[][] corner3 = { { -1, -1 }, { -1, -2, -2, -1 }, { -1, -3, -3, -1 }, { -1, -5, -2, -4, -2, -3, -3, -2, -4, -2, -5, -1 },
			{ -1, -6, -2, -5, -2, -4, -4, -2, -5, -2, -6, -1 } };

	private static int[][] corner4 = { { 0, -1 }, { 1, -1, 0, -2 }, { 2, -1, 0, -3 }, { 4, -1, 3, -2, 2, -2, 1, -3, 1, -4, 0, -5 },
	...
	public RoundedCornerBorder(ColorProvider lineColor, ColorProvider highlightColor, int cType1, int cType2, int cType3, int cType4, boolean drawTop,
			boolean drawLeft, boolean drawBottom, boolean drawRight) {
		super(lineColor, highlightColor, createCoordinates(cType1, cType2, cType3, cType4, drawTop, drawLeft, drawBottom, drawRight), createXScales(cType1,
				cType2, cType3, cType4), createYScales(cType1, cType2, cType3, cType4));
	...
	private static int[] createCoordinates(int cType1, int cType2, int cType3, int cType4, boolean drawTop, boolean drawLeft, boolean drawBottom,
			boolean drawRight) {
