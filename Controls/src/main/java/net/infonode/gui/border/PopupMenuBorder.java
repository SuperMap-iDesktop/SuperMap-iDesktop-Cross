...
public class PopupMenuBorder implements Border, Serializable {
	...
	public void paintBorder(Component component, Graphics graphics, int x, int y, int width, int height) {
		...
		GraphicsUtil.drawOptimizedLine(graphics, x + 1, y + 1, x + width - 2, y + 1);
		GraphicsUtil.drawOptimizedLine(graphics, x + 1, y + 2, x + 1, y + 2);
		GraphicsUtil.drawOptimizedLine(graphics, x + 1, y + height - 2, x + 1, y + height - 2);
	}
