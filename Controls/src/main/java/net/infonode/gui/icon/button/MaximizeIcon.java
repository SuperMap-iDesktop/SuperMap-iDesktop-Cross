...
public class MaximizeIcon extends AbstractButtonIcon {
  ...
  protected void paintIcon(Component component, Graphics graphics, int x1, int y1, int x2, int y2) {
    GraphicsUtil.drawOptimizedLine(graphics, x1, y1, x2, y1);
    GraphicsUtil.drawOptimizedLine(graphics, x1, y1 + 1, x2, y1 + 1);
    GraphicsUtil.drawOptimizedLine(graphics, x1, y1 + 2, x1, y2);
    GraphicsUtil.drawOptimizedLine(graphics, x2, y1 + 2, x2, y2);
    GraphicsUtil.drawOptimizedLine(graphics, x1 + 1, y2, x2 - 1, y2);
  }
}
