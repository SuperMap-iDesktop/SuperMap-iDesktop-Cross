...
//		tableFieldNameCaptionType.getTablesModel().removeTableModelListener(tableModelListener);
//		tableFieldNameCaptionType.getTablesModel().addTableModelListener(tableModelListener);
