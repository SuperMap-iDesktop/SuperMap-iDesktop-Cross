...
public class WorkspaceTree extends JTree implements IDisposable {
	...
	private void addWorkFlowChangedListener() {
		Application.getActiveApplication().addWorkFlowChangedListener(workFlowsChangedListener);
	}
	...
	private void removeWorkFlowChangedListener() {
		Application.getActiveApplication().removeWorkFlowChangedListener(workFlowsChangedListener);
	}
