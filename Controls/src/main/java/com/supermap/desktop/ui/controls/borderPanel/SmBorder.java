 ...
 * 来自SwingExamples
 */
public class SmBorder extends TitledBorder {
	protected JComponent component;

	public SmBorder(JComponent component) {
		this(null, component, LEFT, TOP);
	}

	public SmBorder(Border border) {
		this(border, null, LEFT, TOP);
	}

	public SmBorder(Border border, JComponent component) {
