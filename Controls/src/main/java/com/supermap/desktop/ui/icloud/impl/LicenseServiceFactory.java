...
import com.supermap.desktop.ui.icloud.online.AuthenticatorImpl;
import com.supermap.desktop.ui.icloud.online.UsernamePassword;
...
public class LicenseServiceFactory {
    ...
    private static SSLContext loadSSLContext(String resource) {
        ...
        URL url = ControlsResources.getResourceURL("/controlsresources/StartComKeystore");
