...
/**
 * A {@link com.supermap.desktop.ui.docking.drop.DropFilter} that will reject drop of any window.
 *
...
public class RejectAllDropFilter implements DropFilter {
	 ...
	 */
	public final static RejectAllDropFilter INSTANCE = new RejectAllDropFilter();
