...
public class DefaultDockingStrategy implements DockingStrategy,
	 ...
	 *
	 * @param dockable the {@code Dockable} whose sibling is to be returned
	 ...
	 *
	 * @param dockable the {@code Dockable} whose sibling is to be returned
	 * @param region   the region of the specified {@code Dockable} whose visual
	 ...
	 *
	 * @param comp the {@code Component} whose region is to be returned
	 ...
	 * @param port     the {@code DockingPort} into which we wish to dock
	 * @param region   the region of the specified {@code DockingPort} into which we
	 *                 wish to dock.
	 ...
	 * borders.
	 *
	 * @param base   the {@code DockingPort} off of which the returned
	 *               {@code JSplitPane} will be based.
	 * @param region the region within the base {@code DockingPort} used to
	 ...
	 *
	 * @param port      the {@code DockingPort} that contains the specified
	 *                  {@code JSplitPane}.
	 * @param splitPane the {@code JSplitPane} whose initial divider location is to be
	 *                  determined.
	 ...
	 * returned.
	 *
	 * @param port      the {@code DockingPort} that contains, or will contain the
