...
public class InfoNodeLookAndFeelReleaseInfo {
	private InfoNodeLookAndFeelReleaseInfo() {
		// 工具类不提供构造函数
	}

	private static ReleaseInfo productInfo = new ReleaseInfo("InfoNode Look and Feel GPL", "NNL Technology AB", AntUtils.getBuildTime(1235486816015L),
			AntUtils.createProductVersion(1, 6, 1), "GNU General Public License, Version 2", "http://www.infonode.net");
