...
public class InfoNodeLookAndFeelThemes {
	...
	public static InfoNodeLookAndFeelTheme getDarkBlueGreenTheme() {
		...
		return new InfoNodeLookAndFeelTheme("Dark Blue Green Theme", Color.getHSBColor(hue, saturation, 0.5f), Color.getHSBColor(hue, saturation + 0.1f, 0.9f),
				Color.getHSBColor(Colors.SAND_HUE, 0.04f, 0.5f), Color.WHITE, new Color(0, 170, 0), Color.WHITE, 0.8);
	}
	...
	public static InfoNodeLookAndFeelTheme getGrayTheme() {
		...
		return new InfoNodeLookAndFeelTheme("Gray Theme", new Color(220, 220, 220), Color.getHSBColor(hue, saturation + 0.3f, 1f),
				InfoNodeLookAndFeelTheme.DEFAULT_BACKGROUND_COLOR, InfoNodeLookAndFeelTheme.DEFAULT_TEXT_COLOR, Color.getHSBColor(hue, saturation, 1.0f),
				Color.BLACK);
	}
	...
	public static InfoNodeLookAndFeelTheme getBlueIceTheme() {
		...
		InfoNodeLookAndFeelTheme theme = new InfoNodeLookAndFeelTheme("Blue Ice Theme", color, Color.getHSBColor(hue, saturation + 0.3f, 1f),
				InfoNodeLookAndFeelTheme.DEFAULT_BACKGROUND_COLOR, InfoNodeLookAndFeelTheme.DEFAULT_TEXT_COLOR,
				Color.getHSBColor(hue, saturation - 0.15f, 0.9f), Color.BLACK, 0.3);
	...
	public static InfoNodeLookAndFeelTheme getSoftGrayTheme() {
		InfoNodeLookAndFeelTheme theme = new InfoNodeLookAndFeelTheme("Soft Gray Theme", new Color(230, 230, 233), new Color(212, 220, 236), new Color(255,
				255, 255), new Color(0, 0, 0), new Color(76, 113, 188), new Color(255, 255, 255), 0.2);
		...
		theme.setInactiveInternalFrameTitleBackgroundColor(new Color(220, 220, 222));
