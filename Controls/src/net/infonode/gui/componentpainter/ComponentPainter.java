...
public interface ComponentPainter {
   ...
   */
  void paint(Component component, Graphics graphics, int x, int y, int width, int height);
   ...
   */
  void paint(Component component, Graphics graphics, int x, int y, int width, int height, Direction direction,
