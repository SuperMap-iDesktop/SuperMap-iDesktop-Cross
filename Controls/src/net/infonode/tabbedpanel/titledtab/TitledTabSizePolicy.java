...
/**
 * TitledTabSizePolicy defines how TitledTab should calculate its size. If the different tab states results in different tab sizes, then TitledTab can calculate
 * the maximum size for the states and use that size for all the states.
 *
...
public final class TitledTabSizePolicy extends Enum {
	...
	/**
	 * Equal size policy. This menas that if the different tab states results in different tab sizes, then titled tab will calculate the maximum size for the
	 ...
	 */
	private static final TitledTabSizePolicy[] SIZE_POLICIES = new TitledTabSizePolicy[] { EQUAL_SIZE, INDIVIDUAL_SIZE };
