...
/**
 * Methods for retrieving UI defaults for the current "Look and Feel" from the UIManager. The values are adapted to be used with classes in the TabbedPanel
 * package.
 *
 * @author $Author: johan $
...
public class TabbedUIDefaults {
	...
	public static Color getContentAreaBackground() {
		final String Background = "Panel.background";
		return UIManagerUtil.getColor(Background, "control", Color.LIGHT_GRAY);
	}
	...
	public static Font getFont() {
		Font defaultTabFont = UIManagerUtil.getFont("TabbedPane.font");
		return new Font(null, defaultTabFont.getStyle(), defaultTabFont.getSize());
	}
