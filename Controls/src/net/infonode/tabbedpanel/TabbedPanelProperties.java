...
/**
 * TabbedPanelProperties holds all properties for a {@link TabbedPanel}. A TabbedPanelProperties object contains separate property objects for the content area,
 * the tab area, the tab area components and the buttons of the TabbedPanel.
 *
...
public class TabbedPanelProperties extends PropertyMapContainer {
	 ...
	 */
	public static final BooleanProperty TAB_REORDER_ENABLED = new BooleanProperty(PROPERTIES, "Tab Reorder Enabled", "Tab reorder enabled or disabled",
	 ...
	 * @see #getAbortDragKey
	 */
	public static final IntegerProperty ABORT_DRAG_KEY = IntegerProperty.createPositive(PROPERTIES, "Abort Drag Key Code", "Key code for aborting drag", 3,
			PropertyMapValueHandler.INSTANCE);
	 ...
	 */
	public static final TabLayoutPolicyProperty TAB_LAYOUT_POLICY = new TabLayoutPolicyProperty(PROPERTIES, "Layout Policy", "Tab layout in tab area",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since ITP 1.1.0
	 */
	public static final TabDropDownListVisiblePolicyProperty TAB_DROP_DOWN_LIST_VISIBLE_POLICY = new TabDropDownListVisiblePolicyProperty(PROPERTIES,
			"Tab Drop Down List Visible Policy", "Determins when a drop down list with tabs should be visible in the tab area",
			PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since ITP 1.1.0
	 */
	public static final TabSelectTriggerProperty TAB_SELECT_TRIGGER = new TabSelectTriggerProperty(PROPERTIES, "Tab Select Trigger",
			"Determins when a tab should be selected", PropertyMapValueHandler.INSTANCE);
	 ...
	 */
	public static final IntegerProperty TAB_SCROLLING_OFFSET = IntegerProperty.createPositive(PROPERTIES, "Scroll Offset",
			"Number of pixels to be shown for the last scrolled tab", 3, PropertyMapValueHandler.INSTANCE);
	 ...
	 */
	public static final BooleanProperty ENSURE_SELECTED_VISIBLE = new BooleanProperty(PROPERTIES, "Ensure Selected Visible",
			"Upon select, the selected tab will be scrolled into the visible area.", PropertyMapValueHandler.INSTANCE);
	 ...
	 */
	public static final DirectionProperty TAB_AREA_ORIENTATION = new DirectionProperty(PROPERTIES, "Tab Area Orientation",
			"Tab area's orientation relative to the content area.", PropertyMapValueHandler.INSTANCE);
	 ...
	 * @see #getTabSpacing
	 */
	public static final IntegerProperty TAB_SPACING = new IntegerProperty(PROPERTIES, "Tab Spacing",
			"Number of pixels between tabs in tab area. A negative value will result in tab overlapping.", Integer.MIN_VALUE, Integer.MAX_VALUE, 3,
			PropertyMapValueHandler.INSTANCE);
	 ...
	 * @see #getAutoSelectTab
	 */
	public static final BooleanProperty AUTO_SELECT_TAB = new BooleanProperty(PROPERTIES, "Auto Select Tab",
	 ...
	 */
	public static final BooleanProperty TAB_DESELECTABLE = new BooleanProperty(PROPERTIES, "Tab Deselectable",
			"When enabled the selected tab can be deselected by clicking on it.", PropertyMapValueHandler.INSTANCE);
	 ...
	 * @see #getContentPanelProperties
	 */
	public static final PropertyMapProperty CONTENT_PANEL_PROPERTIES = new PropertyMapProperty(PROPERTIES, "Content Panel Properties",
			"Content panel properties.", TabbedPanelContentPanelProperties.PROPERTIES);
	 ...
	 * @see #getTabAreaProperties
	 */
	public static final PropertyMapProperty TAB_AREA_PROPERTIES = new PropertyMapProperty(PROPERTIES, "Tab Area Properties", "Tab area properties.",
	 ...
	 * @since ITP 1.1.0
	 */
	public static final PropertyMapProperty TAB_AREA_COMPONENTS_PROPERTIES = new PropertyMapProperty(PROPERTIES, "Tab Area Components Properties",
			"Tab area components properties.", TabAreaComponentsProperties.PROPERTIES);
	 ...
	 * @since ITP 1.3.0
	 */
	public static final PropertyMapProperty BUTTON_PROPERTIES = new PropertyMapProperty(PROPERTIES, "Tabbed Panel Button Properties",
			"Tabbed panel button properties.", TabbedPanelButtonProperties.PROPERTIES);
	 ...
	 */
	public static final BooleanProperty SHADOW_ENABLED = new BooleanProperty(PROPERTIES, "Shadow Enabled",
	...
	public static final HoverListenerProperty HOVER_LISTENER = new HoverListenerProperty(PROPERTIES, "Hover Listener",
			"Hover Listener to be used for tracking mouse hovering over the tabbed panel.", PropertyMapValueHandler.INSTANCE);
	 ...
	 * @since ITP 1.3.0
	 */
	public static final TabbedPanelHoverPolicyProperty HOVER_POLICY = new TabbedPanelHoverPolicyProperty(PROPERTIES, "Hover Policy",
			"Policy for when the Tabbed Panel is considerd hovered by the mouse.", PropertyMapValueHandler.INSTANCE);
	...
	public static final BooleanProperty PAINT_TAB_AREA_SHADOW = new BooleanProperty(PROPERTIES, "Paint Tab Area Shadow",
			"Paint a shadow for the tab area. If this property is set to false a shadow is painted for "
					+ "the highlighted tab and the tab area components panel.", PropertyMapValueHandler.INSTANCE);
	 ...
	 * @see #getShadowSize
	 */
	public static final IntegerProperty SHADOW_SIZE = IntegerProperty.createPositive(PROPERTIES, "Shadow Size", "The size of the tab shadow.", 2,
			PropertyMapValueHandler.INSTANCE);
	 ...
	 */
	public static final IntegerProperty SHADOW_BLEND_AREA_SIZE = IntegerProperty.createPositive(PROPERTIES, "Shadow Blend Size",
			"The size of the tab shadow blend area.", 2, PropertyMapValueHandler.INSTANCE);
	...
	public static final FloatProperty SHADOW_STRENGTH = new FloatProperty(
			...
			PropertyMapValueHandler.INSTANCE, 0, 1);

	/**
	 * Array with all properties that controls the functional behavior
	 */
	private static final Property[] FUNCTIONAL_PROPERTIES = { TAB_REORDER_ENABLED, ABORT_DRAG_KEY, TAB_LAYOUT_POLICY, ENSURE_SELECTED_VISIBLE, AUTO_SELECT_TAB,
			TAB_DESELECTABLE, TAB_SELECT_TRIGGER, HOVER_POLICY };

	/**
	 * Array with all properties that controls the shadow
	 */
	private static final Property[] SHADOW_PROPERTIES = { SHADOW_ENABLED, SHADOW_SIZE, SHADOW_BLEND_AREA_SIZE, SHADOW_COLOR, SHADOW_STRENGTH };

	/**
	 * Array with all properties that controls the visual apperance except for shadow
	 */
	private static final Property[] TABS_VISUAL_PROPERTIES = { TAB_SCROLLING_OFFSET, TAB_SPACING, TAB_AREA_ORIENTATION, TAB_AREA_PROPERTIES,
			TAB_AREA_COMPONENTS_PROPERTIES, TAB_LAYOUT_POLICY, CONTENT_PANEL_PROPERTIES, TAB_DROP_DOWN_LIST_VISIBLE_POLICY };

	/**
	 * Array with all properties that controls the visual apperance including shadow
	 */
	private static final Property[] VISUAL_PROPERTIES = (Property[]) ArrayUtil.append(TABS_VISUAL_PROPERTIES, SHADOW_PROPERTIES,
		...
		PropertyMapManager.runBatch(new Runnable() {
			...
			public void run() {
				DEFAULT_PROPERTIES.getContentPanelProperties().getComponentProperties()
						...
						.setInsets(TabbedUIDefaults.getContentAreaInsets()).setBackgroundColor(TabbedUIDefaults.getContentAreaBackground());
				...
				DEFAULT_PROPERTIES
						...
						.setBorder(
								new CompoundBorder(new TabAreaLineBorder(TabbedUIDefaults.getDarkShadow()), new HighlightBorder(false, TabbedUIDefaults
										.getHighlight()))).setBackgroundColor(TabbedUIDefaults.getContentAreaBackground());
	...
	private static void updateFunctionalProperties() {
		DEFAULT_PROPERTIES.setTabReorderEnabled(false).setAbortDragKey(KeyEvent.VK_ESCAPE).setTabLayoutPolicy(TabLayoutPolicy.SCROLLING)
				.setTabDropDownListVisiblePolicy(TabDropDownListVisiblePolicy.NEVER).setTabSelectTrigger(TabSelectTrigger.MOUSE_PRESS)
				.setTabScrollingOffset(10).setTabSpacing(-1).setTabDepthOrderPolicy(TabDepthOrderPolicy.DESCENDING).setEnsureSelectedTabVisible(false)
				.setTabAreaOrientation(Direction.UP).setAutoSelectTab(true).setHighlightPressedTab(true)

				.setHoverPolicy(TabbedPanelHoverPolicy.NO_HOVERED_CHILD)

				.setShadowEnabled(false).setShadowSize(3).setShadowBlendAreaSize(2).setShadowColor(Color.BLACK).setShadowStrength(0.4F);
		...
		for (int i = 0; i < directions.length; i++) {
			...
			((ButtonProperties) buttonMap.get(directions[i])).setFactory(TabbedPanelDefaultButtonFactories.getScrollDownButtonFactory())
					.setIcon(new ArrowIcon(iconSize, directions[i])).setDisabledIcon(new BorderIcon(disabledIcon, 1));
		}
		...
		DEFAULT_PROPERTIES.getButtonProperties().getTabDropDownListButtonProperties()
				...
				.setIcon(new DropDownIcon(Color.black, TabbedUIDefaults.getButtonIconSize(), Direction.DOWN)).setDisabledIcon(null);
	}
	 ...
	 * </p>
	 * <p>
	 * <strong>Note: </strong> This property will only have effect if shadow is enabled.
	 * </p>
	 *
	...
	/**
	 * Sets if automatic selection of a tab is enabled. Automatic selection means that if no tab is selected and a tab is added to the TabbedPanel, then the
	 * added tab will automatically be selected. If a selected tab is removed from the TabbedPanel then the tab next to the selected tab will automatically be
	 * selected.
	 *
	...
	/**
	 * Sets if tab is deselectable. This means that if the selected tab is clicked then the selected tab will be deselected. Clicking it again will select the
	 * tab again.
	 *
	...
	/**
	 * <p>
	 * Sets if a tab should be made visible if it is selected, i.e. if scrolling is enabled, a tab will be scrolled into the visible part of the tab area when
	 * it becomes selected.
	 * </p>
	 * <p>
	 * <strong>Note: </strong> This will only have effect if scolling is enabled.
	 * </p>
	 *
	 ...
	 * </p>
	 * <p>
	 * <strong>Note: </strong> The right mouse button can also be used to abort the operation.
	 * </p>
	 *
	 ...
	 *
	 * <p>
	 * The drop down list will show an icon for the tab if the tab implements the {@link net.infonode.gui.icon.IconProvider} and the text will be retrieved by
	 * calling toString() on the tab.
	 * </p>
	 *
	 ...
	 * </p>
	 *
	 * @param value number of pixels. A negative value reuslts in tabs overlapping each other with the number of pixels.
	 * @return this TabbedPanelProperties
	 ...
	 *
	 * <p>
	 * If the depth order is descending, the first tab will be the top most and the last tab the bottom most. If the depth order is ascending, then the first
	 * tab will be the bottom most and the last tab the top most. Note that if a tab is highlighted, it will always be shown as the top most tab.
	 * </p>
	 *
	...
	/**
	 * Gets if automatic selection of a tab is enabled. Automatic selection means that if no tab is selected and a tab is added to the TabbedPanel, then the
	 * added tab will automatically be selected. If a selected tab is removed from the TabbedPanel then the tab next to the selected tab will automatically be
	 * selected.
	 *
	...
	/**
	 * Gets if tab is deselectable. This means that if the selected tab is clicked then the selected tab will be deselected. Clicking it again will select the
	 * tab again.
	 *
	...
	/**
	 * <p>
	 * Gets if a tab should be made visible if it is selected, i.e. if scrolling is enabled, a tab will be scrolled into the visible part of the tab area when
	 * it becomes selected.
	 * </p>
	 * <p>
	 * <strong>Note: </strong> This will only have effect if scolling is enabled.
	 ...
	 *
	 * @return true if a shadow is painted for the tab area, false if a shadow is painted for the highlighted tab and the tab area components panel
	 * @since ITP 1.1.0
	 */
	...
	/**
	 * Set to true if a shadow should be painted for the tab area, false if a shadow should be painted for the highlighted tab and the tab area components
	 * panel.
	 *
	 * @param paintShadow true if a shadow should be painted for the tab area, false if a shadow should be painted for the highlighted tab and the tab area
	 *            components panel
	 * @return this
	 * @since ITP 1.1.0
	 */
	 ...
	 *
	 * <p>
	 * The hover policy determines when the tabbed panel is considered hovered by the mouse and the hover listener is called. The default hover policy is
	 * NO_HOVERED_CHILD.
	 * </p>
	 *
	...
	public static Property[] getFunctionalProperties() {
		return FUNCTIONAL_PROPERTIES;
	}

	public static Property[] getVisualProperties() {
