...
/**
 * TabLineBorder draws a 1 pixel wide line around a {@link Tab}. If tab spacing in the tabbed panel is 0 then the border will only draw a single line between
 * two adjacent tabs.
 *
 * @author $Author: johan $
...
public class TabLineBorder implements Border, Serializable {
	 ...
	 *
	 * @param color the line color
	 * @param drawBottomLine true if a line should be drawn on the side towards the tabbed panel's content area, otherwise false
	 */
	 ...
	 *
	 * @param drawBottomLine true if a line should be drawn on the side towards the tabbed panel's content area, otherwise false
	 * @param drawTopLine true if a line should be drawn on the side opposite to the tabbed panel's content area, otherwise false
	 */
	...
	/**
	 * Constructs a TabLineBorder that draws lines on three sides of the tab. No line will be drawn on the side towards the tabbed panel's content area. The
	 * inner border will be drawn inside of this TabLineBorder.
	 *
	 * @param color the line color
