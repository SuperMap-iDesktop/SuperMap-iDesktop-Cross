 ...
 * The action is meant to be set as a {@link HoverListener} in the {@link TitledTabProperties}.
 * </p>
 *
 * <p>
 * If the TitledTab is hovered again before the delay has timed out, the timer is reset. If the TitledTab is removed before the delay has timed out the hover
 * listener's mouseExit() will be called immediately.
 * </p>
 *
 * @author johan
...
public class TitledTabDelayedMouseExitHoverAction implements HoverListener {
	 ...
	 *
	 * @param delay delay in milliseconds before the hover listener is called when the titled tab is no longer hovered
	 ...
	 *
	 * @return reference to the TitledTabProperties or null if the delayed action is not a TitledTabHoverAction
	 */
