...
public class InternalPropertiesUtil {
	 ...
	 * @param panel the shaped panel on which to apply the property values
	 */
	public static final void applyTo(ShapedPanelProperties properties, ShapedPanel panel, Direction direction) {
		...
		panel.setDirection(direction == null ? properties.getDirection() : direction);
