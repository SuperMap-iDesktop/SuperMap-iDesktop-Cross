...
public class ArrayUtil {
	...
	public static boolean equalMethod(int[] a, int aOffset, int[] b, int bOffset, int length) {
	...
	public static boolean equalMethod(byte[] a, int aOffset, byte[] b, int bOffset, int length) {
		for (int i = 0; i < length; i++)
			if (a[aOffset + i] != b[bOffset + i])
				return false;
